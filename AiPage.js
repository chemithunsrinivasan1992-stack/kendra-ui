      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-6" style={{ paddingLeft: "35px" }}>
            <div class="product-details-section"><div class="product-badges"><span class="badge bestseller">Bestseller</span><span class="badge extended">Extended Sizes</span></div><h1 class="product-title">Juliette Gold Band Ring in White CZ</h1><div class="persona-ai-content"><div class="ai-badge-card"><div class="ai-icon">🤖</div><div class="ai-badge-text"><h3>Recommended by AI</h3><p>Here's why this is perfect for you...</p></div></div><div class="ai-points-grid"><div class="ai-point-card"><div class="point-icon">✨</div><div class="point-content"><strong>Premium Materials</strong><p>Genuine gold-plated brass offers superior durability compared to standard fashion jewelry</p></div></div><div class="ai-point-card"><div class="point-icon">👗</div><div class="point-content"><strong>Versatile Design</strong><p>Works with 90% of your wardrobe - from casual to formal</p></div></div><div class="ai-point-card"><div class="point-icon">💎</div><div class="point-content"><strong>Investment Value</strong><p>Designed to last generations, not just seasons</p></div></div></div><div class="technical-validation-card"><div class="card-header"><span class="card-icon">🔬</span><h4>Technical Validation</h4></div><div class="validation-content"><p><strong>Genuine Gold-Plated Brass</strong> is softer and more durable than standard plated materials. Our plating process uses 14K gold overlay, ensuring long-lasting shine.</p></div></div><div class="expert-endorsement-card"><div class="endorsement-icon">👑</div><div class="endorsement-content"><strong>Fashion Editor's Pick</strong><p>"This piece perfectly balances elegance and versatility. A true investment piece."</p><span class="endorsement-source">- Vogue Style Team</span></div></div><div class="sustainability-card"><div class="card-header"><span class="card-icon">🌱</span><h4>Sustainability &amp; Longevity</h4></div><div class="sustainability-points-grid"><div class="sustainability-point"><span class="check-icon">✓</span><span>Ethically sourced materials</span></div><div class="sustainability-point"><span class="check-icon">✓</span><span>Designed for lifetime wear</span></div><div class="sustainability-point"><span class="check-icon">✓</span><span>Repairable at any Kendra Scott store</span></div></div></div><div class="lifetime-value-card"><div class="value-icon">💰</div><div class="value-content"><span class="value-label">Cost per wear over 10 years</span><span class="value-amount">$0.06</span><span class="value-note">Based on wearing 2x per week</span></div></div><div class="trust-signals-card"><div class="card-header"><span class="card-icon">⭐</span><h4>Trust &amp; Quality Metrics</h4></div><div class="trust-metrics-grid"><div class="trust-metric-card"><span class="metric-number">98%</span><span class="metric-label">Customer Satisfaction</span></div><div class="trust-metric-card"><span class="metric-number">2.3%</span><span class="metric-label">Return Rate</span></div><div class="trust-metric-card"><span class="metric-number">20+</span><span class="metric-label">Years in Business</span></div></div></div></div><div class="product-price-section"><span class="product-price">$60.00</span></div><div class="financing-options"><a href="#" class="financing-link">More Financing Options</a></div><div class="discount-note">Discount Automatically Applies in Cart.</div><div class="product-options"><div class="option-group"><label class="option-label">Metal</label><div class="option-buttons"><button class="option-btn active">Gold</button></div></div><div class="option-group"><label class="option-label">Size <a href="#" class="size-guide-link">Size Guide</a></label><div class="size-selector"><button class="size-btn ">4</button><button class="size-btn active">5</button><button class="size-btn ">6</button><button class="size-btn ">7</button><button class="size-btn ">8</button><button class="size-btn ">9</button><button class="size-btn ">10</button><button class="size-btn ">11</button><button class="size-btn ">12</button></div></div><div class="option-group"><label class="option-label">Store Availability</label><select class="store-select"><option>Select a Store</option><option>New York - 5th Avenue</option><option>Los Angeles - Beverly Hills</option><option>Chicago - Michigan Avenue</option></select></div></div><button class="add-to-bag-btn">Add to Bag</button><div class="product-info-icons"><div class="info-icon-item"><span class="info-icon">🚚</span><span>Free shipping on orders $85+.</span></div><div class="info-icon-item"><span class="info-icon">↩️</span><span>Free &amp; Easy Returns. <a href="#">Return Policy</a></span></div><div class="info-icon-item"><span class="info-icon">🎁</span><span>Gifting made easy. Add our complimentary gift box at checkout.</span></div></div></div>
          </div>
        </div>
